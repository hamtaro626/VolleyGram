...
test/
  migration.js  586 checks: storage, migration, roles, formations, quiz,
...
```sh
node test/migration.js    # 586 checks across 50 groups
...
v0.31. Working title, actively developed, no issues or PRs open yet.
