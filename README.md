...
test/
  migration.js  594 checks: storage, migration, roles, formations, quiz,
...
```sh
node test/migration.js    # 594 checks across 50 groups
...
v0.32. Working title, actively developed, no issues or PRs open yet.
