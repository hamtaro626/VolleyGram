...
test/
  migration.js  570 checks: storage, migration, roles, formations, quiz,
...
```sh
node test/migration.js    # 570 checks across 49 groups
...
v0.28. Working title, actively developed, no issues or PRs open yet.
