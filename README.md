...
test/
  migration.js  613 checks: storage, migration, roles, formations, quiz,
...
```sh
node test/migration.js    # 613 checks across 50 groups
...
v0.36. Working title, actively developed, no issues or PRs open yet.
