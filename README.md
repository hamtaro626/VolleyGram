...
test/
  migration.js  715 checks: storage, migration, roles, formations, quiz,
...
```sh
node test/migration.js    # 715 checks across 58 groups
...
v0.44. Working title, actively developed, no issues or PRs open yet.
