...
test/
  migration.js  606 checks: storage, migration, roles, formations, quiz,
...
```sh
node test/migration.js    # 606 checks across 50 groups
...
v0.35. Working title, actively developed, no issues or PRs open yet.
